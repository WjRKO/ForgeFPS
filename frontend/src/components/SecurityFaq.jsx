...
const COPY = {
  it: {
    ...
    items: [
      ...
      { q: "Serve accedere come amministratore?", a: "Solo per applicare le ottimizzazioni reali di sistema, con privilegi minimi. Il codice è open source (licenza AGPL-3.0): puoi ispezionare esattamente cosa fa prima di eseguirlo." },
  ...
  en: {
    ...
    items: [
      ...
      { q: "Do I need administrator access?", a: "Only to apply real system optimizations, with least privilege. The code is open source (AGPL-3.0 license): you can inspect exactly what it does before running it." },
