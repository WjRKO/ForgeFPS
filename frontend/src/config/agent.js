...
export const AGENT_EXE_URL = "https://github.com/WjRKO/ForgeFPS/releases/download/v0.7.6/forgefps-agent.zip";
export const AGENT_EXE_SHA256 = "fd294dd4504877d714064fc92aed0270aba77c64d36bd4799685b4187eddba18";
export const AGENT_EXE_VERSION = "v0.7.6";
export const AGENT_EXE_DATE = "2026-07-25";
