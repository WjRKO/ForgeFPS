...
const COPY = {
  it: {
    ...
    tiers: [
      {
        ...
        items: [
          ...
          "AI Advisor — 5 messaggi di benvenuto + crediti extra con missioni e trofei",
      ...
      },
      {
        ...
        items: [
          ...
          "AI Advisor — 50 messaggi/settimana su misura per il tuo hardware",
          "Diagnosi AI + Gameplay Doctor (analisi sessione di gioco)",
      ...
      },
      {
        ...
        items: [
          "Tutto di Pro, più:",
          "AI Advisor illimitata — nessun limite settimanale",
    ...
    features_matrix: [
      ...
      { label: "AI Advisor", values: ["5 msg + crediti da missioni", "50 msg/settimana", "Illimitata"] },
      { label: "Diagnosi AI + Gameplay Doctor", values: [false, true, true] },
  ...
  en: {
    ...
    tiers: [
      {
        ...
        items: [
          ...
          "AI Advisor — 5 welcome messages + extra credits from missions & trophies",
      ...
      },
      {
        ...
        items: [
          ...
          "AI Advisor — 50 messages/week tailored to your hardware",
          "AI Diagnose + Gameplay Doctor (game session analysis)",
      ...
      },
      {
        ...
        items: [
          ...
          "Unlimited AI Advisor — no weekly cap",
    ...
    features_matrix: [
      ...
      { label: "Quick Benchmark (~30s)", values: [true, true, true] },
      { label: "Full Benchmark (~3min)", values: [false, true, true] },
      { label: "AI Advisor", values: ["5 msgs + mission credits", "50 msgs/week", "Unlimited"] },
      { label: "AI Diagnose + Gameplay Doctor", values: [false, true, true] },
      { label: "Live Monitor", values: [false, true, true] },
