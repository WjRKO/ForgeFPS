...
from routers import advisor, builds, products, pc, push_routes, admin, profiles, discord as discord_router, subscriptions
...
for module in (advisor, builds, products, pc, push_routes, admin, profiles, discord_router, subscriptions):
